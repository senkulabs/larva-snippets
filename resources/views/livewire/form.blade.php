    ...
    <form wire:submit="save" x-data="{ showPassword: false, showPasswordConfirmation: false }">
        ...
        <div class="mb-4">
            <fieldset class="block">
                ...
                <label class="block">
                    <input type="checkbox" value="walking" wire:model="hobbies"> Walking
                </label>
                <label class="block">
                    <input type="checkbox" value="cycling" wire:model="hobbies"> Cycling
                </label>
                <label class="block">
                    <input type="checkbox" value="weight training" wire:model="hobbies"> Weight Training
                </label>
                <label class="block">
                    <input type="checkbox" value="swimming" wire:model="hobbies"> Swimming
                </label>
                <label class="block">
                    <input type="checkbox" value="playing music" wire:model="hobbies"> Playing Music
                </label>
                <label class="block">
                    <input type="checkbox" value="sing a song" wire:model="hobbies"> Sing a Song
                </label>
                <label class="block">
                    <input type="checkbox" value="other" wire:model="hobbies"> Other
                </label>
                <div>
                    <label for="">
                        Please tell me your hobby
                        <input type="text" wire:model="otherHobby" placeholder="My hobby is" class="rounded">
                    </label>
                </div>
